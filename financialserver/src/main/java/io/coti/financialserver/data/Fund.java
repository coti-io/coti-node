...
public enum Fund {
    ...
    public static Fund getTokenSaleRelatedFundNameByText(String text) throws IllegalArgumentException {
    ...
    public static Fund getFundByText(String text) throws IllegalArgumentException {
        for (Fund fund : values()) {
