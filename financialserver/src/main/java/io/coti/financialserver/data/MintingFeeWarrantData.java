...
public class MintingFeeWarrantData implements IEntity, ISignable, ISignValidatable {
    ...
    public static transient final int WARRANT_TERM_MINUTES = 10;
    ...
    public MintingFeeWarrantData(Hash currencyHash, Instant requestTime, BigDecimal amount, BigDecimal feeGiven) {
        ...
        this.amount = amount;
        this.feeGiven = feeGiven;
        this.runningAlready = false;
    }
