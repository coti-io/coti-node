...
public class AlphaNetBenchmarkBatching {
    private double _median;
    private double _mean;

    public AlphaNetBenchmarkBatching(int sampleSize, byte[] targetDifficulty, int trustScore) {
        ...
        for (int i = 0; i < sampleSize; i++) {
            ...
            AlphaNetProofOfWork pow = new AlphaNetProofOfWork(orderData[i], trustScore);
