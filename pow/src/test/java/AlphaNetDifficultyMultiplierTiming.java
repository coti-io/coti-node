...
public class AlphaNetDifficultyMultiplierTiming {
    ...
    public void batchRun(String easierHexDifficulty, int trustScore, int sampleSize, int difficultyMultiplier) {
        ...
        AlphaNetBenchmarkBatching easierBatching = new AlphaNetBenchmarkBatching(sampleSize, easierDifficulty, trustScore);
        ...
        AlphaNetBenchmarkBatching harderBatching = new AlphaNetBenchmarkBatching(sampleSize, harderDifficulty, trustScore);
