...
[![Current Version](https://img.shields.io/badge/version-1.2.3--SNAPSHOT-yellow.svg)](https://github.com/coti-io/coti-node/)
...
java -jar fullnode/target/fullnode-1.2.3-SNAPSHOT.jar --spring.config.additional-location=fullnode1.properties
```
#### Docker container
