...
[![Current Version](https://img.shields.io/badge/version-2.1.0--SNAPSHOT-yellow.svg)](https://github.com/coti-io/coti-node/)
...
java -jar fullnode/target/fullnode-2.1.0-SNAPSHOT.jar --spring.config.additional-location=fullnode1.properties
```
#### Docker container
