...
[![Current Version](https://img.shields.io/badge/version-1.5.0.RELEASE-green.svg)](https://github.com/coti-io/coti-node/)
...
java -jar fullnode/target/fullnode-1.5.0.RELEASE.jar --spring.config.additional-location=fullnode1.properties
```
#### Docker container
