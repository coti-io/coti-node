...
[![Current Version](https://img.shields.io/badge/version-2.0.1.RELEASE-green.svg)](https://github.com/coti-io/coti-node/)
...
java -jar fullnode/target/fullnode-2.0.1.RELEASE.jar --spring.config.additional-location=fullnode1.properties
```
#### Docker container
