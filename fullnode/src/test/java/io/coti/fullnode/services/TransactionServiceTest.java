...
public class TransactionServiceTest {
    ...
    public void addNewTransaction_Succeed() {
        ...
        response = transactionService.addNewTransaction(generateAddTransactionRequest());
        Assert.assertEquals(INVALID_FULL_NODE_FEE, response.getBody().getMessage());

        // Fail on Base Tx sum check
        when(validationService.validateFullNodeFeeDataIntegrity(any(TransactionData.class))).thenReturn(true);
        response = transactionService.addNewTransaction(generateAddTransactionRequest());
    ...
    public void getAddressTransactions() {
        ...
        Set<Hash> txsHistoryList = new HashSet<>();
