...
public class TransactionServiceTest {
    ...
    public void getAddressTransactions() {
        ...
        ResponseEntity<IResponse> response = transactionService.getAddressTransactions(addressHash);

        Assert.assertEquals("Success", ((BaseResponse)response.getBody()).getStatus());
    }
    ...
    public void getTransactionDetails() {
        ...
        ResponseEntity<IResponse> response = transactionService.getTransactionDetails(transactionHash);
