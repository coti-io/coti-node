...
@ContextConfiguration(classes = {IClusterStampService.class, IDatabaseConnector.class,
...
public class ClusterStampServiceTest {
    ...
    public GetClusterStampFileNamesResponse getClusterStampFileNamesRequest = new GetClusterStampFileNamesResponse();
...
//        clusterStampNames.delete(token1);
    ...
    public void testMyFileStream(){
        //clusterStampService.getClusterStampFromRecoveryServer();
    }
