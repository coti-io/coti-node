...
public class TrustScoreService {
    ...
    public ResponseEntity<BaseResponse> getTransactionTrustScore(Hash userHash, Hash transactionHash, SignatureData signatureData) {
        ...
        GetTransactionTrustScoreResponse getTransactionTrustScoreResponse = buildGetTransactionTrustScoreResponse(trustScoreData, userHash, transactionHash);
    ...
    private GetTransactionTrustScoreResponse buildGetTransactionTrustScoreResponse(TrustScoreData trustScoreData, Hash userHash, Hash transactionHash) {
        ...
        return new GetTransactionTrustScoreResponse(transactionTrustScoreResponseData);
    }
