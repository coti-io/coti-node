...
import io.coti.trustscore.rulesData.BaseEventScore;
import io.coti.trustscore.rulesData.BehaviorEventsScore;
...
public class EventsDecayCalculator {
    ...
    private Map<EventType,Function> getValueEventMapper = new HashMap<EventType,Function>(){{
            put(EventType.DISPUTE, e-> new Argument("X",((DisputeEventData)e).getTransactionData().getSendingAmount().doubleValue()));
