...
public class HttpStringConstants extends BaseNodeHttpStringConstants {
    ...
    public static final String ADD_CENTRAL_EVENT_ERROR = "Adding central event Failed";
    public static final String CENTRAL_EVENT_EXIST = "central event already exist";
