...
public class HttpStringConstants extends BaseNodeHttpStringConstants {
    ...
    public static final String BAD_SIGNATURE_ON_TRUST_SCORE_FOR_TRANSACTION = "Transaction trust score bad signature";
    ...
    public static final String MERCHANT_ADDRESS_GET_ERROR = "Error at getting merchant address: %s";
