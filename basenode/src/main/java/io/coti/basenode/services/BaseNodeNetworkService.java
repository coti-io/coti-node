...
public class BaseNodeNetworkService implements INetworkService {
    ...
    private Map<Hash, NetworkNodeData> getMapFromFactory(NodeType nodeType) {
    ...
    public void setNetworkNodesMap(Map<Hash, NetworkNodeData> networkNodesMap, NodeType nodeType) {
    ...
    @Override
    public List<NetworkNodeData> getNetworkDataList() {
