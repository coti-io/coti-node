...
public enum OutputBaseTransactionName {
    FullNodeFeeData(EnumSet.of(TransactionType.Payment, TransactionType.Transfer, TransactionType.TokenGeneration, TransactionType.TokenMinting)),
    NetworkFeeData(EnumSet.of(TransactionType.Payment, TransactionType.Transfer)),
    TokenServiceFeeData(EnumSet.of(TransactionType.TokenGeneration, TransactionType.TokenMinting)),
