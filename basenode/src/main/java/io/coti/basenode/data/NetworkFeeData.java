...
public class NetworkFeeData extends OutputBaseTransactionData implements ITrustScoreNodeValidatable {
    ...
    public NetworkFeeData(Hash addressHash, Hash currencyHash, BigDecimal amount, Hash originalCurrencyHash, BigDecimal originalAmount, BigDecimal reducedAmount, Instant createTime) {
