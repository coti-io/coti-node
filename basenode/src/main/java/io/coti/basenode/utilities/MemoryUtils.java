...
public class MemoryUtils {
    ...
    public static String debugInfo() {
        String heapInfo = "JVM heap information: " + memBean.getHeapMemoryUsage().toString() + ", %used: ".concat(String.valueOf(MemoryUtils.getPercentageUsedHeap()));
        String heapMem = "heap information: " + heapMemoryUsage.toString();
        String memInfo = "memory information: max " + getMaxMemory() + ", total: " + getTotalMemory() + ", free: " + getFreeMemory() + ", %: " + getPercentageUsed();
        return heapInfo.concat("\n").concat(heapMem).concat("\n").concat(memInfo);
    }
}
