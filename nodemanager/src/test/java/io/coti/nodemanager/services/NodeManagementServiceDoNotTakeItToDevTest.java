...
//            addNodeBeginPairEventRequest.setEndTime(endEventDateTime);
    ...
    @Test
    public void prepareData_getNodesPercentages() {
        NetworkNodeData networkNodeData7 = new NetworkNodeData();
        networkNodeData7.setHash(fakeNode7);
        networkNodeData7.setNodeType(NodeType.FullNode);
        networkNodeData7.setAddress("test");
        ...
        LocalDateTime startDateTime = LocalDateTime.of(2020, 1, 15, 0, 0, 0);
        ...
        nodeStatus = NetworkNodeStatus.INACTIVE;
        iPlace = 2;
        localDateTime = LocalDateTime.of(startDateTime.getYear(), startDateTime.getMonth(), startDateTime.getDayOfMonth() + 5, iPlace, iPlace, 0).toInstant(ZoneOffset.UTC);
        nodeManagementService.addNodeHistory(networkNodeData7, nodeStatus, localDateTime);

        nodeStatus = NetworkNodeStatus.ACTIVE;
        iPlace = 3;
        localDateTime = LocalDateTime.of(startDateTime.getYear(), startDateTime.getMonth(), startDateTime.getDayOfMonth() + 10, iPlace, iPlace, 0).toInstant(ZoneOffset.UTC);
        nodeManagementService.addNodeHistory(networkNodeData7, nodeStatus, localDateTime);
        ...
        Instant newEventDateTime = LocalDateTime.of(2020, 1, 1, 0, 0, 0).toInstant(ZoneOffset.UTC);
