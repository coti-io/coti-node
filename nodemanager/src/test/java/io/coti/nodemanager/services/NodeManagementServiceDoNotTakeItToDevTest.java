...
@Slf4j
@ContextConfiguration(classes = {NodeManagementService.class, RocksDBConnector.class, NodeHistory.class, NodeDayMaps.class, InitializationService.class, NetworkHistoryService.class})
